                ...
                <Offcanvas.Body>
                  ...
                  <div className="BuscaCep">
                    <form onSubmit={handleSubmit(onSubmit)}>
                      <input type="text" className="cepExibe" placeholder="Rua"{...register("address")} />
                      <input type="text" className="cepExibe" placeholder="Número"{...register("addressNumber")} />
                      <input type="text" className="cepExibe" placeholder="Bairro"{...register("neighborhood")} />
                      <input type="text" className="cepExibe" placeholder="Cidade"{...register("city")} />
                      <input type="text" className="cepExibe" placeholder="Estado"{...register("uf")} />
                    </form>
                  </div>
