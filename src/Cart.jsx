                ...
                <div className="ContainerColumn">
                  <div className="QuadradoFrete">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                      <input type="text" className="cepExibeCarrinho" placeholder="Rua"{...register("address")} />
                      <input type="text" className="cepExibeCarrinho" placeholder="Número"{...register("addressNumber")} />
                      <input type="text" className="cepExibeCarrinho" placeholder="Bairro"{...register("neighborhood")} />
                      <input type="text" className="cepExibeCarrinho" placeholder="Cidade"{...register("city")} />
                      <input type="text" className="cepExibeCarrinho" placeholder="Estado"{...register("uf")} />
                    </form>
                  </div>
